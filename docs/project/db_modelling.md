...
This guide explains how to design, register, migrate, and manage relational database models inside the template. It also covers CSV import/export and RBAC‑protected CRUD operations.
